...
CREATE VIEW public.ca_daily AS
 SELECT _materialized_hypertable_7.metric_key,
    _materialized_hypertable_7.bucket_start,
    _materialized_hypertable_7.value
   FROM _timescaledb_internal._materialized_hypertable_7
  WHERE (_materialized_hypertable_7.bucket_start < COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(7)), '-infinity'::timestamp with time zone))
UNION ALL
 SELECT e.metric_key,
    public.time_bucket('1 day'::interval, e.occurred_at, 'America/Chicago'::text) AS bucket_start,
    COALESCE(public.last(((e.payload ->> 'value'::text))::numeric, e.recorded_at) FILTER (WHERE (e.type = 'MetricRecorded'::text)), sum(((e.payload ->> 'value'::text))::numeric) FILTER (WHERE (e.type = 'MetricIncremented'::text))) AS value
   FROM public.events e
  WHERE ((e.type = ANY (ARRAY['MetricRecorded'::text, 'MetricIncremented'::text])) AND (e.occurred_at >= COALESCE(_timescaledb_functions.to_timestamp(_timescaledb_functions.cagg_watermark(7)), '-infinity'::timestamp with time zone)))
  GROUP BY e.metric_key, (public.time_bucket('1 day'::interval, e.occurred_at, 'America/Chicago'::text));
...
--
-- Name: _hyper_10_311_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_10_311_chunk (
...
--
-- Name: _hyper_10_312_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_10_312_chunk (
    CONSTRAINT constraint_312 CHECK (((bucket_start >= '2020-12-23 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2021-03-03 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_10);


--
-- Name: _hyper_10_313_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_10_313_chunk (
    CONSTRAINT constraint_313 CHECK (((bucket_start >= '2023-11-08 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2024-01-17 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_10);


--
-- Name: _hyper_10_314_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_10_314_chunk (
...
--
-- Name: _hyper_7_244_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_244_chunk (
    CONSTRAINT constraint_244 CHECK (((bucket_start >= '2023-08-30 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-11-08 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_245_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_245_chunk (
    CONSTRAINT constraint_245 CHECK (((bucket_start >= '2021-12-08 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2022-02-16 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_246_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_246_chunk (
    CONSTRAINT constraint_246 CHECK (((bucket_start >= '2021-03-03 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2021-05-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_247_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_247_chunk (
    CONSTRAINT constraint_247 CHECK (((bucket_start >= '2022-04-27 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-07-06 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_248_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_248_chunk (
    CONSTRAINT constraint_248 CHECK (((bucket_start >= '2020-12-23 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2021-03-03 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_249_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_249_chunk (
    CONSTRAINT constraint_249 CHECK (((bucket_start >= '2021-09-29 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-12-08 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_250_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_250_chunk (
    CONSTRAINT constraint_250 CHECK (((bucket_start >= '2023-06-21 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-08-30 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_251_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_251_chunk (
    CONSTRAINT constraint_251 CHECK (((bucket_start >= '2021-05-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-07-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_252_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_252_chunk (
    CONSTRAINT constraint_252 CHECK (((bucket_start >= '2022-11-23 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2023-02-01 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_253_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_253_chunk (
    CONSTRAINT constraint_253 CHECK (((bucket_start >= '2023-11-08 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2024-01-17 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_254_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_254_chunk (
    CONSTRAINT constraint_254 CHECK (((bucket_start >= '2023-04-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-06-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_255_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_255_chunk (
    CONSTRAINT constraint_255 CHECK (((bucket_start >= '2022-07-06 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-09-14 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_256_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_256_chunk (
    CONSTRAINT constraint_256 CHECK (((bucket_start >= '2024-06-05 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-08-14 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_257_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_257_chunk (
    CONSTRAINT constraint_257 CHECK (((bucket_start >= '2021-07-21 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-09-29 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_258_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_258_chunk (
    CONSTRAINT constraint_258 CHECK (((bucket_start >= '2024-03-27 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-06-05 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_259_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_259_chunk (
    CONSTRAINT constraint_259 CHECK (((bucket_start >= '2022-09-14 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-11-23 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_260_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_260_chunk (
    CONSTRAINT constraint_260 CHECK (((bucket_start >= '2023-02-01 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2023-04-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_261_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_261_chunk (
    CONSTRAINT constraint_261 CHECK (((bucket_start >= '2022-02-16 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2022-04-27 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_262_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_262_chunk (
    CONSTRAINT constraint_262 CHECK (((bucket_start >= '2024-01-17 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2024-03-27 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_263_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_263_chunk (
    CONSTRAINT constraint_263 CHECK (((bucket_start >= '2024-08-14 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-10-23 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_264_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_264_chunk (
    CONSTRAINT constraint_264 CHECK (((bucket_start >= '2024-10-23 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-01-01 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_265_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_265_chunk (
    CONSTRAINT constraint_265 CHECK (((bucket_start >= '2025-05-21 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-07-30 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_266_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_266_chunk (
    CONSTRAINT constraint_266 CHECK (((bucket_start >= '2025-03-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-05-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_267_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_267_chunk (
    CONSTRAINT constraint_267 CHECK (((bucket_start >= '2025-01-01 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2025-03-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);


--
-- Name: _hyper_7_268_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_7_268_chunk (
    CONSTRAINT constraint_268 CHECK (((bucket_start >= '2025-07-30 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-10-08 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_7);
...
--
-- Name: _hyper_8_269_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_269_chunk (
    CONSTRAINT constraint_269 CHECK (((bucket_start >= '2024-03-27 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-06-05 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_270_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_270_chunk (
    CONSTRAINT constraint_270 CHECK (((bucket_start >= '2023-11-08 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2024-01-17 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_271_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_271_chunk (
    CONSTRAINT constraint_271 CHECK (((bucket_start >= '2022-09-14 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-11-23 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_272_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_272_chunk (
    CONSTRAINT constraint_272 CHECK (((bucket_start >= '2021-05-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-07-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_273_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_273_chunk (
    CONSTRAINT constraint_273 CHECK (((bucket_start >= '2021-12-08 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2022-02-16 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_274_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_274_chunk (
    CONSTRAINT constraint_274 CHECK (((bucket_start >= '2024-10-23 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-01-01 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_275_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_275_chunk (
    CONSTRAINT constraint_275 CHECK (((bucket_start >= '2024-08-14 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-10-23 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_276_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_276_chunk (
    CONSTRAINT constraint_276 CHECK (((bucket_start >= '2023-04-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-06-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_277_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_277_chunk (
    CONSTRAINT constraint_277 CHECK (((bucket_start >= '2020-12-23 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2021-03-03 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_278_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_278_chunk (
    CONSTRAINT constraint_278 CHECK (((bucket_start >= '2022-11-23 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2023-02-01 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_279_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_279_chunk (
    CONSTRAINT constraint_279 CHECK (((bucket_start >= '2025-05-21 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-07-30 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_280_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_280_chunk (
    CONSTRAINT constraint_280 CHECK (((bucket_start >= '2022-04-27 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-07-06 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_281_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_281_chunk (
    CONSTRAINT constraint_281 CHECK (((bucket_start >= '2024-06-05 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-08-14 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_282_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_282_chunk (
    CONSTRAINT constraint_282 CHECK (((bucket_start >= '2021-07-21 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-09-29 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_283_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_283_chunk (
    CONSTRAINT constraint_283 CHECK (((bucket_start >= '2021-09-29 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-12-08 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_284_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_284_chunk (
    CONSTRAINT constraint_284 CHECK (((bucket_start >= '2021-03-03 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2021-05-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_285_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_285_chunk (
    CONSTRAINT constraint_285 CHECK (((bucket_start >= '2022-07-06 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-09-14 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_286_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_286_chunk (
    CONSTRAINT constraint_286 CHECK (((bucket_start >= '2025-03-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-05-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_287_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_287_chunk (
    CONSTRAINT constraint_287 CHECK (((bucket_start >= '2023-06-21 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-08-30 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_288_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_288_chunk (
    CONSTRAINT constraint_288 CHECK (((bucket_start >= '2024-01-17 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2024-03-27 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_289_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_289_chunk (
    CONSTRAINT constraint_289 CHECK (((bucket_start >= '2022-02-16 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2022-04-27 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_290_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_290_chunk (
    CONSTRAINT constraint_290 CHECK (((bucket_start >= '2023-02-01 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2023-04-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_291_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_291_chunk (
    CONSTRAINT constraint_291 CHECK (((bucket_start >= '2025-01-01 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2025-03-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_292_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_8_292_chunk (
    CONSTRAINT constraint_292 CHECK (((bucket_start >= '2023-08-30 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-11-08 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_8);


--
-- Name: _hyper_8_315_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--
...
--
-- Name: _hyper_9_293_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_293_chunk (
    CONSTRAINT constraint_293 CHECK (((bucket_start >= '2021-05-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-07-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_294_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_294_chunk (
    CONSTRAINT constraint_294 CHECK (((bucket_start >= '2022-02-16 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2022-04-27 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_295_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_295_chunk (
    CONSTRAINT constraint_295 CHECK (((bucket_start >= '2025-03-12 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-05-21 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_296_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_296_chunk (
    CONSTRAINT constraint_296 CHECK (((bucket_start >= '2022-09-14 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-11-23 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_297_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_297_chunk (
    CONSTRAINT constraint_297 CHECK (((bucket_start >= '2024-10-23 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2025-01-01 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_298_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_298_chunk (
    CONSTRAINT constraint_298 CHECK (((bucket_start >= '2023-02-01 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2023-04-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_299_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_299_chunk (
    CONSTRAINT constraint_299 CHECK (((bucket_start >= '2024-08-14 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-10-23 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_300_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_300_chunk (
    CONSTRAINT constraint_300 CHECK (((bucket_start >= '2021-12-08 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2022-02-16 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_301_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_301_chunk (
    CONSTRAINT constraint_301 CHECK (((bucket_start >= '2020-12-23 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2021-03-03 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_302_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_302_chunk (
    CONSTRAINT constraint_302 CHECK (((bucket_start >= '2024-03-27 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-06-05 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_303_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_303_chunk (
    CONSTRAINT constraint_303 CHECK (((bucket_start >= '2023-11-08 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2024-01-17 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_304_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_304_chunk (
    CONSTRAINT constraint_304 CHECK (((bucket_start >= '2021-09-29 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2021-12-08 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_305_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_305_chunk (
    CONSTRAINT constraint_305 CHECK (((bucket_start >= '2024-06-05 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2024-08-14 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_306_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_306_chunk (
    CONSTRAINT constraint_306 CHECK (((bucket_start >= '2022-04-27 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2022-07-06 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_307_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_307_chunk (
    CONSTRAINT constraint_307 CHECK (((bucket_start >= '2023-08-30 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-11-08 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_308_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_308_chunk (
    CONSTRAINT constraint_308 CHECK (((bucket_start >= '2021-03-03 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2021-05-12 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_309_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_309_chunk (
    CONSTRAINT constraint_309 CHECK (((bucket_start >= '2022-11-23 18:00:00-06'::timestamp with time zone) AND (bucket_start < '2023-02-01 18:00:00-06'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);


--
-- Name: _hyper_9_310_chunk; Type: TABLE; Schema: _timescaledb_internal; Owner: -
--

CREATE TABLE _timescaledb_internal._hyper_9_310_chunk (
    CONSTRAINT constraint_310 CHECK (((bucket_start >= '2023-06-21 19:00:00-05'::timestamp with time zone) AND (bucket_start < '2023-08-30 19:00:00-05'::timestamp with time zone)))
)
INHERITS (_timescaledb_internal._materialized_hypertable_9);
...
--
-- Name: _hyper_10_311_chunk__materialized_hypertable_10_bucket_start_id; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_311_chunk__materialized_hypertable_10_bucket_start_id ON _timescaledb_internal._hyper_10_311_chunk USING btree (bucket_start DESC);


--
-- Name: _hyper_10_311_chunk__materialized_hypertable_10_metric_key_buck; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_311_chunk__materialized_hypertable_10_metric_key_buck ON _timescaledb_internal._hyper_10_311_chunk USING btree (metric_key, bucket_start DESC);


--
-- Name: _hyper_10_312_chunk__materialized_hypertable_10_bucket_start_id; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_312_chunk__materialized_hypertable_10_bucket_start_id ON _timescaledb_internal._hyper_10_312_chunk USING btree (bucket_start DESC);


--
-- Name: _hyper_10_312_chunk__materialized_hypertable_10_metric_key_buck; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_312_chunk__materialized_hypertable_10_metric_key_buck ON _timescaledb_internal._hyper_10_312_chunk USING btree (metric_key, bucket_start DESC);


--
-- Name: _hyper_10_313_chunk__materialized_hypertable_10_bucket_start_id; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_313_chunk__materialized_hypertable_10_bucket_start_id ON _timescaledb_internal._hyper_10_313_chunk USING btree (bucket_start DESC);


--
-- Name: _hyper_10_313_chunk__materialized_hypertable_10_metric_key_buck; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_313_chunk__materialized_hypertable_10_metric_key_buck ON _timescaledb_internal._hyper_10_313_chunk USING btree (metric_key, bucket_start DESC);


--
-- Name: _hyper_10_314_chunk__materialized_hypertable_10_bucket_start_id; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_314_chunk__materialized_hypertable_10_bucket_start_id ON _timescaledb_internal._hyper_10_314_chunk USING btree (bucket_start DESC);


--
-- Name: _hyper_10_314_chunk__materialized_hypertable_10_metric_key_buck; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_10_314_chunk__materialized_hypertable_10_metric_key_buck ON _timescaledb_internal._hyper_10_314_chunk USING btree (metric_key, bucket_start DESC);
...
--
-- Name: _hyper_1_100_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_100_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_100_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_101_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_101_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_101_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_102_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_102_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_102_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_103_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_103_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_103_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_104_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_104_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_104_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_105_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_105_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_105_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_106_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_106_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_106_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_107_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_107_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_107_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_108_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_108_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_108_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_109_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_109_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_109_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_10_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_10_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_10_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_110_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_110_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_110_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_111_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_111_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_111_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_112_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_112_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_112_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_113_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_113_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_113_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_114_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_114_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_114_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_115_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_115_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_115_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_116_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_116_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_116_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_117_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_117_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_117_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_118_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_118_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_118_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_119_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_119_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_119_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_11_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_11_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_11_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_120_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_120_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_120_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_121_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_121_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_121_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_122_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_122_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_122_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_123_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_123_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_123_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_124_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_124_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_124_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_125_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_125_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_125_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_126_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_126_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_126_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_127_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_127_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_127_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_128_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_128_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_128_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_129_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_129_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_129_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_12_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_12_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_12_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_130_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_130_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_130_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_131_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_131_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_131_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_132_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_132_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_132_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_133_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_133_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_133_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_134_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_134_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_134_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_135_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_135_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_135_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_136_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_136_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_136_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_137_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_137_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_137_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_138_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_138_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_138_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_139_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_139_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_139_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_13_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_13_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_13_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_140_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_140_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_140_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_141_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_141_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_141_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_142_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_142_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_142_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_143_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_143_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_143_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_144_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_144_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_144_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_145_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_145_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_145_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_146_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_146_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_146_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_147_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_147_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_147_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_148_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_148_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_148_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_149_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_149_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_149_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_14_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_14_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_14_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_150_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_150_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_150_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_151_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_151_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_151_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_152_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_152_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_152_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_153_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_153_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_153_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_154_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_154_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_154_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_155_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_155_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_155_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_156_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_156_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_156_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_157_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_157_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_157_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_158_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_158_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_158_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_159_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_159_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_159_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_15_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_15_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_15_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_160_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_160_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_160_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_161_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1_161_chunk_idx_events_type_time ON _timescaledb_internal._hyper_1_161_chunk USING btree (type, occurred_at);
...
--
-- Name: _hyper_1_162_chunk_idx_events_type_time; Type: INDEX; Schema: _timescaledb_internal; Owner: -
--

CREATE INDEX _hyper_1